...
public class SortingSpeedComparison {
	public static void main(String[] args) {
		...
		Integer[] arr1 = new Integer[n], arr2 = new Integer[n], arr3 = new Integer[n], arr4 = new Integer[n],
				  arr5 = new Integer[n], arr6 = new Integer[n], arr7 = new Integer[n];

		for(int i = 0; i < n; i++)
			arr1[i] = arr2[i] = arr3[i] = arr4[i] = arr5[i] = arr6[i] = arr7[i] = generator.nextInt();
...
// 		 Arrays.sort(arr7);
	    ...
	    System.out.println("Time taken by RandomizedQuickSort (O(n log n) behaviour expected): " + (System.currentTimeMillis() - start) + " ms" );

		start = System.currentTimeMillis();
		NonRecursiveRandomizedQuickSort.sort(arr4);
		System.out.println("Time taken by NonRecursiveRandomizedQuickSort (O(n log n) behaviour expected): " + (System.currentTimeMillis() - start) + " ms" );
